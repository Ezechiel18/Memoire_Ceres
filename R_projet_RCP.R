...
nc_path <- "I:/Memoire/SIG/Rendu_Ceres_Flore/Data/Enrichissement/RCP_85_Precipitation_eur/pr_CORDEX-EUR_rcp85_mon_200601-210012.nc"
raster_brick <- rast(nc_path, subds = "pr")  # ou nom exact de la variable dans le fichie .nc
